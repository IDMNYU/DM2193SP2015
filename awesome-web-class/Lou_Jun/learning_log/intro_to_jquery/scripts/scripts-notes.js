...
// var myHeading = document.querySelector("#my-heading"); // One
// var myHeading = document.querySelectorAll("#my-heading"); // Many
...
// myHeading.style['background-color'] = "#ccc";
...
// $myHeading.removeClass('my-alternate-heading');
...
// jQuery Element Creation -- Example 1
var $myBox = $('<div />', { 
    class: 'my-box' 
})
.text('My Box');

// jQuery Element Creation -- Example 2
// var $myBox = $('<div />');
// $myBox.addClass('my-box');
// $myBox.text('<h1>My Box</h1>'); // strips markup
// $myBox.html('<h1>My Box</h1>');
// $myBox.appendTo(document.body);

// $(document.body).append($myBox);

// jQuery HTML Method lets you run scripts **DANGEROUS*******
// $('html').html('<script> document.location = "http://www.ebay.com" </script>');
...
//     $myBox[0].classList.toggle('inactive');
// });
